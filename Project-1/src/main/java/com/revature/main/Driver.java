...
//				System.out.println(car.toString());
		...
		public static void add(ArrayList<Manufacturer> manufacturers) {
			...
			System.out.println(carToInsert + "was successfully added to Database. Please choose another option.");
		...
		public static void update() {
			...
			System.out.println("Please enter the PrimaryKey of the car you'd like to remove from the database: ");
			int carPK = scan.nextInt();
			
			carToUpdate = carDao.selectCar(carPK);
			System.out.println("Returning selected car: " + carToUpdate);
			System.out.println("Please enter a variable you'd like to update: ");
			String variable = scan.next();
			if(variable.equals("color")) {
				System.out.println("Current color is: " + carToUpdate.getColor());
				System.out.println("Please enter the new color: ");
				String newColor = scan.next();
				carToUpdate.setColor(newColor);
				carDao.update(carToUpdate, carPK);
				System.out.println("Color has been successfully changed to: " + carToUpdate.getColor());
			} 	else if(variable.equals("horsepower")) {
				System.out.println("Current horspower is: " + carToUpdate.getHorsePower());
				System.out.println("Please enter the new horsepower: ");
				int newHorsePower = scan.nextInt();
				carToUpdate.setHorsePower(newHorsePower);
				carDao.update(carToUpdate, carPK);
				System.out.println("Horsepower has been successfully changed to: " + carToUpdate.getHorsePower());
			} else if(variable.equals("acceleration")) {
				System.out.println("Current acceleration is: " + carToUpdate.getZeroToSixty());
				System.out.println("Please enter the new acceleration: ");
				double newAcceleration = scan.nextDouble();
				carToUpdate.setZeroToSixty(newAcceleration);
				carDao.update(carToUpdate, carPK);
				System.out.println("Acceleration has been successfully changed to: " + carToUpdate.getZeroToSixty());
			} else if(variable.equals("top speed")) {
				System.out.println("Current top speed is: " + carToUpdate.getTopSpeed());
				System.out.println("Please enter the new top speed: ");
				double newTopSpeed = scan.nextDouble();
				carToUpdate.setTopSpeed(newTopSpeed);
				carDao.update(carToUpdate, carPK);
				System.out.println("Top speed has been successfully changed to: " + carToUpdate.getTopSpeed());
			} else if(variable.equals("mpg")) {
				System.out.println("Current mpg is: " + carToUpdate.getMpg());
				System.out.println("Please enter the new mpg: ");
				double newMpg = scan.nextDouble();
				carToUpdate.setMpg(newMpg);
				carDao.update(carToUpdate, carPK);
				System.out.println("MPGr has been successfully changed to: " + carToUpdate.getMpg());
			} else if(variable.equals("transmission")) {
				System.out.println("Current transmission is: " + carToUpdate.getTransmission());
				System.out.println("Please enter the new transmission type in ALL CAPS: ");
				String newTransmission = scan.next();
				TransmissionType transEnum = TransmissionType.valueOf(newTransmission);
				carToUpdate.setTransmission(transEnum);
				carDao.update(carToUpdate, carPK);
				System.out.println("Horsepower has been successfully changed to: " + carToUpdate.getTransmission());
			} else {
